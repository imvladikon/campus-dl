...
"""
Common type definitions and constants for campus-dl

The classes in this module represent the structure of courses in campus.  The
structure is:
...
class Course(object):
    ...
    def __init__(self, id, name, url, state):
        """
        @param id: The id of a course in campus is composed by the path
